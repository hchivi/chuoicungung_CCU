  ...
  return (
    ...
    <div className="clickup-card-border w-full shadow-sm hover:shadow-md transition-shadow duration-300">
      ...
      <div className="relative z-10 w-full bg-white rounded-[22px] overflow-hidden">
        ...
        {/* Top Banner Ribbon */}
        <div className="bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 text-slate-950 px-3.5 sm:px-4 py-2 flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs font-black tracking-wide border-b border-amber-300 gap-2">
          <div className="flex items-center space-x-2 flex-wrap gap-y-1">
            <Award className="w-4 h-4 text-slate-950 animate-bounce shrink-0" />
            <span className="uppercase tracking-wider font-heading text-[10.5px] sm:text-xs font-black">
              {lang === 'en' ? 'FOUNDING PARTNER SPOTLIGHT' : 'NHÀ CUNG CẤP NỔI BẬT - ĐỐI TÁC SÁNG LẬP'}
            </span>
            <span className="inline-block bg-slate-950 text-yellow-400 text-[10px] sm:text-xs px-2 sm:px-2.5 py-0.5 rounded-full font-mono font-bold shadow-xs">
          ...
          <div className="flex items-center space-x-2 shrink-0 self-end sm:self-auto">
            <Link
              to="/founding-partner"
              className="relative inline-flex items-center justify-center px-3.5 sm:px-4 py-1.5 rounded-full bg-gradient-to-r from-[#ff007f] via-[#7b2cbf] via-[#3a86ff] via-[#00f2fe] to-[#ffbe0b] animate-gradient-flow text-white font-mono text-[10.5px] sm:text-xs font-black uppercase tracking-wider shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer border border-white/30"
              title={lang === 'en' ? 'Explore Founding Partners Program' : 'Khám phá chương trình Đối Tác Sáng Lập'}
            >
              <span className="flex items-center space-x-1 drop-shadow-xs">
        ...
        <div className="p-3.5 sm:p-5 lg:p-6 grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5 lg:gap-6 items-center">
              ...
              {isPlayingVideo ? (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/35 group-hover:bg-black/20 transition-colors flex items-center justify-center">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-yellow-400 text-slate-950 flex items-center justify-center shadow-xl group-hover:scale-110 group-hover:bg-yellow-300 transition-transform">
                      <Play className="w-6 h-6 sm:w-7 sm:h-7 fill-current ml-1" />
                    </div>
                  </div>
                  {/* Video Play Badge */}
                  <div className="absolute bottom-2.5 left-2.5 sm:bottom-3 sm:left-3 bg-black/80 text-white backdrop-blur-xs px-2.5 py-1 rounded-lg text-[10.5px] sm:text-[11px] font-mono font-bold flex items-center space-x-1.5">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-3.5 sm:space-y-4">
            ...
            <div className="flex items-start justify-between gap-2.5 border-b border-slate-100 pb-3">
              <div className="flex items-start space-x-2.5 sm:space-x-3.5">
                ...
                <a
                  ...
                  className="shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-white border border-slate-200 p-1 shadow-xs hover:border-yellow-400 transition flex items-center justify-center overflow-hidden"
                >
                  <img
                    src={partner.logo}
                    alt={partner.name}
                ...
                <div className="space-y-1">
                  <div className="flex items-center space-x-2 flex-wrap gap-y-0.5">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm sm:text-lg font-black text-slate-950 hover:text-blue-700 transition font-heading uppercase tracking-wide leading-tight"
                    >
                      CHUYÊN GIA ĐỒNG PHỤC
                    </a>

                    {/* Rating moved directly behind name */}
                    <span className="inline-flex items-center text-amber-600 font-black text-[11px] sm:text-xs bg-amber-50 px-2 py-0.5 rounded-full border border-amber-200 shadow-2xs">
                      <Star className="w-2.5 h-2.5 sm:w-3 sm:h-3 fill-current text-amber-500 mr-1" />
                      4.9 <span className="text-slate-400 font-normal ml-0.5">({partner.reviewsCount || 328})</span>
                    </span>
                  </div>

                  {/* Sub-line: Verified + Country + Years */}
                  <div className="flex items-center space-x-2 text-[11px] sm:text-xs text-slate-600 flex-wrap gap-y-0.5">
                    <span className="inline-flex items-center text-blue-600 font-bold bg-blue-50 px-1.5 py-0.5 rounded border border-blue-200 text-[10.5px]">
              ...
              <div className="flex items-center space-x-2 shrink-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl bg-white hover:bg-blue-50 border border-slate-200 hover:border-blue-300 p-1.5 shadow-xs hover:shadow-md flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 cursor-pointer"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl bg-white hover:bg-slate-50 text-slate-700 hover:text-blue-600 border border-slate-200 hover:border-blue-300 p-2 shadow-xs hover:shadow-md flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 cursor-pointer"
            ...
            >
              {/* Header: Slogan + Slider Controls */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 pb-0.5">
                <div className="flex items-center space-x-2">
                  <span className="text-sm sm:text-base lg:text-lg font-black text-amber-900 tracking-tight font-heading leading-snug">
                ...
                <div className="flex items-center space-x-2 self-end sm:self-auto shrink-0">
                  <button
                    ...
                    className="w-7 h-7 sm:w-6 sm:h-6 rounded-full bg-slate-100 hover:bg-yellow-400 text-slate-700 hover:text-slate-950 flex items-center justify-center transition shadow-2xs border border-slate-200 cursor-pointer active:scale-95"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:text-blue-700 hover:underline text-[11px] sm:text-xs font-bold flex items-center ml-1"
                  >
              ...
              {/* Continuous Horizontal Slider with smooth mobile touch */}
              <div
                ref={scrollContainerRef}
                className="flex gap-2.5 sm:gap-3 overflow-x-auto no-scrollbar scroll-smooth py-1 touch-scroll"
              >
                {partner.featuredProducts?.map((product, pIdx) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="shrink-0 w-[130px] sm:w-[155px] lg:w-[160px] group/p bg-slate-50 hover:bg-white rounded-2xl p-2 sm:p-2.5 border border-slate-200 hover:border-yellow-400 hover:shadow-md transition-all flex flex-col items-center justify-between text-center cursor-pointer active:scale-98"
                    title={`Xem danh mục: ${product.name}`}
                  >
                    <div className="w-full aspect-[4/3] rounded-xl overflow-hidden bg-white border border-slate-100 mb-1.5 sm:mb-2 flex items-center justify-center relative p-1 shadow-2xs">
                      <img
                        src={product.image}
                        alt={product.name}
                    ...
                    <div className="w-full h-9 sm:h-10 flex items-center justify-center text-center px-0.5">
                      <h4 className="text-[11.5px] sm:text-[13px] font-black text-slate-900 group-hover/p:text-yellow-700 leading-tight tracking-tight line-clamp-2">
                        {product.name}
                      </h4>
                    </div>
                  </a>
