...
export const demandsMarketplaceData = [
  {
    ...
    location: "TP. Hồ Chí Minh (Nhận hàng Toàn quốc & KCN)",
    ...
    interestedSuppliers: [
      ...
      {
        id: "ent-dongnam",
        name: "Công Ty TNHH Dệt Vải Đông Nam",
        shortName: "Dệt Đông Nam",
        avatar: "https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=100&auto=format&fit=crop&q=80",
        monogram: "ĐN",
      ...
      },
      {
        ...
        shortName: "Vinatex International",
        ...
        status: "Đã xem chi tiết"
      },
      {
        id: "ent-vinhthinh",
        name: "Công Ty Cổ Phần Dệt Vải Vĩnh Thịnh",
        shortName: "Dệt Vĩnh Thịnh",
        avatar: "https://images.unsplash.com/photo-1563178406-4cdc2923acbc?w=100&auto=format&fit=crop&q=80",
        monogram: "VT",
        bgGradient: "from-amber-600 to-orange-600",
        viewedAt: "3 giờ trước",
        status: "Đã liên hệ Zalo"
      },
      {
        id: "ent-ankhang",
        name: "Công Ty TNHH Sản Xuất Vải Sợi An Khang",
        shortName: "Vải Sợi An Khang",
        avatar: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=100&auto=format&fit=crop&q=80",
        monogram: "AK",
        bgGradient: "from-cyan-600 to-blue-600",
        viewedAt: "5 giờ trước",
        status: "Đã xem"
      }
    ],
  ...
  {
    id: "dem-01",
    title: "Cung cấp đồng phục công nhân 5.000 bộ / tháng",
    category: "Sản phẩm",
    company: "Nhà máy Samsung Electronics Việt Nam",
    phone: "0222 369 8888",
    email: "procurement@samsung.vn",
    kcn: "Yên Phong I, Bắc Ninh",
    location: "Bắc Ninh",
    budget: "1,2 tỷ - 1,5 tỷ VND",
    postedDate: "20/05/2024 10:30",
    deadline: "20/06/2024 (Còn 31 ngày)",
    status: "Đang mở",
    phaseId: "5.3",
    stageId: 5,
    interestedSuppliers: [
      { id: "s1", name: "Chuyên Gia Đồng Phục (Proser)", monogram: "PS", bgGradient: "from-blue-600 to-indigo-600", viewedAt: "1 giờ trước" },
      { id: "s2", name: "May Nhà Bè", monogram: "NB", bgGradient: "from-emerald-600 to-teal-600", viewedAt: "3 giờ trước" },
      { id: "s3", name: "May 10", monogram: "M10", bgGradient: "from-purple-600 to-pink-600", viewedAt: "5 giờ trước" }
    ],
    totalInterestedCount: 14
  },
  {
    id: "dem-02",
    title: "Tìm nhà cung cấp bao bì carton 3 lớp in flexo",
    category: "Sản phẩm",
    company: "Nestlé Việt Nam",
    phone: "0251 383 6611",
    email: "sourcing@vn.nestle.com",
    kcn: "Amata, Đồng Nai",
    location: "Đồng Nai",
    budget: "800 triệu - 1 tỷ VND",
    postedDate: "19/05/2024 14:15",
    deadline: "18/06/2024 (Còn 29 ngày)",
    status: "Đang mở",
    phaseId: "4.1",
    stageId: 4,
    interestedSuppliers: [
  ...
  {
    id: "dem-03",
    title: "Dịch vụ vận chuyển quốc tế đường biển (Thường xuyên)",
    category: "Dịch vụ",
    company: "Vinamilk Bình Dương",
    phone: "0274 375 5555",
    email: "logistics-bidding@vinamilk.com.vn",
    kcn: "VSIP II, Bình Dương",
    location: "Bình Dương",
    budget: "2 - 3 tỷ VND/năm",
    postedDate: "18/05/2024 09:45",
    deadline: "30/05/2024 (Còn 10 ngày)",
    status: "Sắp hết hạn",
    phaseId: "4.3",
    stageId: 4,
    interestedSuppliers: [
      { id: "s6", name: "Gemadept Logistics", monogram: "GD", bgGradient: "from-emerald-600 to-teal-600", viewedAt: "30 phút trước" },
      { id: "s7", name: "Tân Cảng Logistics", monogram: "TC", bgGradient: "from-blue-600 to-indigo-600", viewedAt: "2 giờ trước" }
    ],
    totalInterestedCount: 18
  },
  {
    id: "dem-04",
    title: "Hệ thống xử lý nước thải công suất 500 m³/ngày",
    category: "Giải pháp",
    company: "THACO Chu Lai",
    phone: "0235 356 7111",
    email: "dauthau@thaco.com.vn",
    kcn: "Chu Lai, Quảng Nam",
    location: "Quảng Nam",
    budget: "5 - 7 tỷ VND",
    postedDate: "17/05/2024 16:20",
    deadline: "15/06/2024 (Còn 26 ngày)",
    status: "Đang mở",
    phaseId: "2.3",
    stageId: 2,
    interestedSuppliers: [
  ...
  {
    id: "dem-05",
    title: "Linh kiện điện tử: IC, PCB, Connector",
    category: "Sản phẩm",
    company: "Intel Products Vietnam",
    phone: "028 3736 3000",
    email: "b2b-procure@intel.com",
    kcn: "KCN SHTP, TP. Hồ Chí Minh",
    location: "TP. Hồ Chí Minh",
    budget: "3 - 5 tỷ VND",
    postedDate: "16/05/2024 11:05",
    deadline: "25/06/2024 (Còn 36 ngày)",
    status: "Đang mở",
    phaseId: "4.1",
    stageId: 4,
    interestedSuppliers: [
  ...
  {
    id: "dem-06",
    title: "Tuyển dụng lao động phổ thông số lượng 200 người",
    category: "Dịch vụ",
    company: "Sunjin Việt Nam",
    phone: "0226 385 2222",
    email: "tuyendung@sunjin.com.vn",
    kcn: "Đồng Văn IV, Hà Nam",
    location: "Hà Nam",
    budget: "150 - 300 triệu VND/tháng",
    postedDate: "15/05/2024 08:30",
    deadline: "15/06/2024 (Còn 26 ngày)",
    status: "Đang mở",
    phaseId: "5.1",
    stageId: 5,
    interestedSuppliers: [],
    totalInterestedCount: 11
  },
  {
    id: "dem-07",
    title: "Phần mềm quản lý sản xuất (MES) tích hợp ERP",
    category: "Giải pháp",
    company: "Bosch Việt Nam",
    phone: "0251 351 4000",
    email: "it-sourcing@bosch.com",
    kcn: "Long Thành, Đồng Nai",
    location: "Đồng Nai",
    budget: "2 - 4 tỷ VND",
    postedDate: "14/05/2024 15:40",
    deadline: "28/06/2024 (Còn 39 ngày)",
    status: "Đang mở",
    phaseId: "6.3",
    stageId: 6,
    interestedSuppliers: [],
  ...
  {
    id: "dem-08",
    title: "Thi công xây dựng nhà xưởng 10.000 m²",
    category: "Dịch vụ",
    company: "Hyosung Việt Nam",
    phone: "0251 356 9999",
    email: "construction-rfp@hyosung.com",
    kcn: "Nhơn Trạch 5, Đồng Nai",
    location: "Đồng Nai",
    budget: "20 - 25 tỷ VND",
    postedDate: "13/05/2024 13:25",
    deadline: "20/06/2024 (Còn 31 ngày)",
    status: "Đang mở",
    phaseId: "2.2",
    stageId: 2,
